...
from spatial_filters import mean_filter, adaptive_lnr_filter, adaptive_median_filter
...
if __name__ == "__main__":
	...
	g3 = adaptive_lnr_filter(img, var_g, s=7)
	...
	# Plot results
	fig = plt.figure()
	fig.suptitle('Image_04', fontsize=20)
	...
	ax.set_title("Adaptative Median Filter")
